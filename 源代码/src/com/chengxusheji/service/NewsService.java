...
public class NewsService {
    ...
    /*按照查询条件分页查询资讯信息记录*/
    public ArrayList<News> queryNews(NewsClass newsClassObj,String title,PetClass petClassObj,String tixing,String publishDate,int currentPage) throws Exception { 
    	...
    	if(null != petClassObj && petClassObj.getPetClassId()!= null && petClassObj.getPetClassId()!= 0)  where += " and t_news.petClassObj=" + petClassObj.getPetClassId();
    	if(!tixing.equals("")) where = where + " and t_news.tixing like '%" + tixing + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<News> queryNews(NewsClass newsClassObj,String title,PetClass petClassObj,String tixing,String publishDate) throws Exception  { 
     	String where = "where 1=1";
    	if(null != newsClassObj && newsClassObj.getNewsClassId()!= null && newsClassObj.getNewsClassId()!= 0)  where += " and t_news.newsClassObj=" + newsClassObj.getNewsClassId();
    	if(!title.equals("")) where = where + " and t_news.title like '%" + title + "%'";
    	if(null != petClassObj && petClassObj.getPetClassId()!= null && petClassObj.getPetClassId()!= 0)  where += " and t_news.petClassObj=" + petClassObj.getPetClassId();
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(NewsClass newsClassObj,String title,PetClass petClassObj,String tixing,String publishDate) throws Exception {
     	String where = "where 1=1";
    	if(null != newsClassObj && newsClassObj.getNewsClassId()!= null && newsClassObj.getNewsClassId()!= 0)  where += " and t_news.newsClassObj=" + newsClassObj.getNewsClassId();
    	if(!title.equals("")) where = where + " and t_news.title like '%" + title + "%'";
    	if(null != petClassObj && petClassObj.getPetClassId()!= null && petClassObj.getPetClassId()!= 0)  where += " and t_news.petClassObj=" + petClassObj.getPetClassId();
