...
public class ExpertService {
    ...
    /*按照查询条件分页查询宠物专家记录*/
    public ArrayList<Expert> queryExpert(String expertUserName,String name,String birthDate,String school,String telephone,int currentPage) throws Exception { 
    	...
    	if(!school.equals("")) where = where + " and t_expert.school like '%" + school + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Expert> queryExpert(String expertUserName,String name,String birthDate,String school,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!expertUserName.equals("")) where = where + " and t_expert.expertUserName like '%" + expertUserName + "%'";
    	if(!name.equals("")) where = where + " and t_expert.name like '%" + name + "%'";
    	if(!birthDate.equals("")) where = where + " and t_expert.birthDate like '%" + birthDate + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String expertUserName,String name,String birthDate,String school,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!expertUserName.equals("")) where = where + " and t_expert.expertUserName like '%" + expertUserName + "%'";
    	if(!name.equals("")) where = where + " and t_expert.name like '%" + name + "%'";
    	if(!birthDate.equals("")) where = where + " and t_expert.birthDate like '%" + birthDate + "%'";
