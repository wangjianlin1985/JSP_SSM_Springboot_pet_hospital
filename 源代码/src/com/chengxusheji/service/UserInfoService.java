...
public class UserInfoService {
    ...
    /*按照查询条件分页查询用户记录*/
    public ArrayList<UserInfo> queryUserInfo(String user_name,PetClass petClassObj,String nicheng,String birthDate,String sfym,String name,String telephone,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(!user_name.equals("")) where = where + " and t_userInfo.user_name like '%" + user_name + "%'";
    	if(null != petClassObj && petClassObj.getPetClassId()!= null && petClassObj.getPetClassId()!= 0)  where += " and t_userInfo.petClassObj=" + petClassObj.getPetClassId();
    	if(!nicheng.equals("")) where = where + " and t_userInfo.nicheng like '%" + nicheng + "%'";
    	if(!birthDate.equals("")) where = where + " and t_userInfo.birthDate like '%" + birthDate + "%'";
    	if(!sfym.equals("")) where = where + " and t_userInfo.sfym like '%" + sfym + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<UserInfo> queryUserInfo(String user_name,PetClass petClassObj,String nicheng,String birthDate,String sfym,String name,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!user_name.equals("")) where = where + " and t_userInfo.user_name like '%" + user_name + "%'";
    	if(null != petClassObj && petClassObj.getPetClassId()!= null && petClassObj.getPetClassId()!= 0)  where += " and t_userInfo.petClassObj=" + petClassObj.getPetClassId();
    	if(!nicheng.equals("")) where = where + " and t_userInfo.nicheng like '%" + nicheng + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String user_name,PetClass petClassObj,String nicheng,String birthDate,String sfym,String name,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!user_name.equals("")) where = where + " and t_userInfo.user_name like '%" + user_name + "%'";
    	if(null != petClassObj && petClassObj.getPetClassId()!= null && petClassObj.getPetClassId()!= 0)  where += " and t_userInfo.petClassObj=" + petClassObj.getPetClassId();
    	if(!nicheng.equals("")) where = where + " and t_userInfo.nicheng like '%" + nicheng + "%'";
