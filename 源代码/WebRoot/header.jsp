...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">宠物医院网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>UserInfo/frontlist">宠物列表</a></li>
                 <!-- 
                <li><a href="<%=basePath %>PetClass/frontlist">宠物类别</a></li>
                <li><a href="<%=basePath %>Reply/frontlist">帖子回复</a></li>
                
                <li><a href="<%=basePath %>OrderInfo/frontlist">预约订单</a></li>
                
                 -->
                <li><a href="<%=basePath %>Expert/frontlist">宠物专家</a></li>
                <li><a href="<%=basePath %>PostInfo/frontlist">论坛交流</a></li>
                <li><a href="<%=basePath %>Leaveword/frontlist">用户咨询</a></li>
                <li><a href="<%=basePath %>News/frontlist">资讯信息</a></li>
                <li><a href="<%=basePath %>NewsClass/frontlist">资讯分类</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>OrderInfo/userFrontlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的预约订单</a></li>
                        <li><a href="<%=basePath %>PostInfo/postInfo_userFrontAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布帖子</a></li>
                        <li><a href="<%=basePath %>PostInfo/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的帖子</a></li>
                        <li><a href="<%=basePath %>Reply/userFrontlist"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我的回复</a></li>
                        <li><a href="<%=basePath %>Leaveword/leaveword_userFrontAdd.jsp"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我要咨询</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的咨询</a></li>
