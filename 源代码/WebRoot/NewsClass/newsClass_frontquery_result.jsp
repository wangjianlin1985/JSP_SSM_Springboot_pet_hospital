		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#newsClassListPanel" aria-controls="newsClassListPanel" role="tab" data-toggle="tab">资讯分类列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>NewsClass/newsClass_frontAdd.jsp" style="display:none;">添加资讯分类</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
				    	            		...
				    	            		for(int i=0;i<newsClassList.size();i++) {
					    	            		...
					    	            		NewsClass newsClass = newsClassList.get(i); //获取到资讯分类对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;资讯分类信息编辑</h4>
      </div>
