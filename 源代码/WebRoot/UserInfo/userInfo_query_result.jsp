...
<div id="userInfo_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="userInfoQueryForm" method="post">
			...
			宠物昵称：<input type="text" class="textbox" id="nicheng" name="nicheng" style="width:110px" />
			出生日期：<input type="text" id="birthDate" name="birthDate" class="easyui-datebox" editable="false" style="width:100px">
			是否接种疫苗：<input type="text" class="textbox" id="sfym" name="sfym" style="width:110px" />
			主人姓名：<input type="text" class="textbox" id="name" name="name" style="width:110px" />
