...
<div class="container">
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=userInfo.getPetClassObj().getPetClassName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">宠物昵称:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getNicheng()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">宠物照片:</div>
		<div class="col-md-10 col-xs-6"><img class="img-responsive" src="<%=basePath %><%=userInfo.getPetPhoto() %>"  border="0px"/></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">体型:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getTixing()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">体重:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getWeight()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">是否接种疫苗:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getSfym()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">主人姓名:</div>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">邮件:</div>
