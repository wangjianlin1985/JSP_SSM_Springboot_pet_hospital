...
<div id="newsAddDiv">
	<form id="newsAddForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="news_petClassObj_petClassId" name="news.petClassObj.petClassId" style="width: auto"/>
			</span>
		</div>
		<div>
			<span class="label">宠物体型:</span>
			<span class="inputControl">
				<input class="textbox" type="text" id="news_tixing" name="news.tixing" style="width:200px" />
