...
<div id="news_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="newsQueryForm" method="post">
			资讯分类：<input class="textbox" type="text" id="newsClassObj_newsClassId_query" name="newsClassObj.newsClassId" style="width: auto"/>
			资讯标题：<input type="text" class="textbox" id="title" name="title" style="width:110px" />
			宠物分类：<input class="textbox" type="text" id="petClassObj_petClassId_query" name="petClassObj.petClassId" style="width: auto"/>
			宠物体型：<input type="text" class="textbox" id="tixing" name="tixing" style="width:110px" />
...
var news_content_editor = UE.getEditor('news_content_edit'); //资讯内容编辑器
</script>
