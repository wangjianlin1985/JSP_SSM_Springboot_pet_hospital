...
<%
    ...
    String expertUserName = (String)request.getAttribute("expertUserName"); //专家账号查询关键字
    String name = (String)request.getAttribute("name"); //姓名查询关键字
    String birthDate = (String)request.getAttribute("birthDate"); //出生日期查询关键字
    String school = (String)request.getAttribute("school"); //毕业学校查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Expert/frontlist">宠物专家信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Expert/expert_frontAdd.jsp" style="display:none;">添加宠物专家</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<expertList.size();i++) {
            		...
            		Expert expert = expertList.get(i); //获取到宠物专家对象
            		String clearLeft = "";
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="expertQueryForm" id="expertQueryForm" action="<%=basePath %>Expert/frontlist" class="mar_t15" method="post">
			<div class="form-group">
				<label for="expertUserName">专家账号:</label>
				<input type="text" id="expertUserName" name="expertUserName" value="<%=expertUserName %>" class="form-control" placeholder="请输入专家账号">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" id="school" name="school" value="<%=school %>" class="form-control" placeholder="请输入毕业学校">
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;宠物专家信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="expert_expertUserName_edit" class="col-md-3 text-right">专家账号:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="expert_expertUserName_edit" name="expert.expertUserName" class="form-control" placeholder="请输入专家账号" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="expert_school_edit" class="col-md-3 text-right">毕业学校:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="expert_school_edit" name="expert.school" class="form-control" placeholder="请输入毕业学校">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="expert_workExperience_edit" class="col-md-3 text-right">工作经验:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="expert_workExperience_edit" name="expert.workExperience" class="form-control" placeholder="请输入工作经验">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="expert_expertDesc_edit" class="col-md-3 text-right">专家详情:</label>
		  	 <div class="col-md-9">
...
<script>
//实例化编辑器
var expert_expertDesc_edit = UE.getEditor('expert_expertDesc_edit'); //专家详情编辑器
