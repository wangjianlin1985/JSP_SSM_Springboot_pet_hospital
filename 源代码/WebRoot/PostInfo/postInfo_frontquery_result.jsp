				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>帖子标题</td><td>宠物分类</td><td>浏览量</td><td>发帖人</td><td>发帖时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=postInfo.getJinghuaFlag().equals("是")?"<font color='red'>【精】</font>" + postInfo.getTitle():postInfo.getTitle() %></td>
 											<td><%=postInfo.getPetClassObj().getPetClassName() %></td>
 											<td><%=postInfo.getHitNum() %></td>
 											<td><%=postInfo.getUserObj().getNicheng() %></td>
