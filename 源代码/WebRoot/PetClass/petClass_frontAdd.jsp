				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="petClassAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="petClass_petClassName" class="col-md-2 text-right">类别名称:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="petClass_petClassName" name="petClass.petClassName" class="form-control" placeholder="请输入类别名称">
							 </div>
						  </div>
				          <div class="form-group">
