...
<%
    ...
    PetClass petClass = (PetClass)request.getAttribute("petClass");
	...
	<ul class="breadcrumb">
		...
		<div class="row"> 
		  ...
		  <div class="form-group">
			 <label for="petClass_petClassId_edit" class="col-md-3 text-right">类别id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="petClass_petClassId_edit" name="petClass.petClassId" class="form-control" placeholder="请输入类别id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="petClass_petClassName_edit" class="col-md-3 text-right">类别名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="petClass_petClassName_edit" name="petClass.petClassName" class="form-control" placeholder="请输入类别名称">
			 </div>
		  </div>
			  <div class="form-group">
			  	<span class="col-md-3""></span>
			  	<span onclick="ajaxPetClassModify();" class="btn btn-primary bottom5 top5">修改</span>
			  </div>
		</form> 
...
$(function(){
        ...
        new WOW().init();
    petClassEdit("<%=request.getParameter("petClassId")%>");
 })
 </script> 
</body>
</html>
